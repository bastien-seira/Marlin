...
#define STRING_CONFIG_H_AUTHOR "BS, SKR 1.4 - JG Aurora A5" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BS, JG A5 - SKR MK3s v1.4"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 24.12 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 12, 38, -2.52 }
